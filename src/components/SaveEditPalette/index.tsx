...
export function SaveEditPalette({
  ...
  return (
    <div className="mt-14 flex font-body flex-col space-x-0 space-y-8 sm:mt-11 sm:flex-row sm:space-y-0 sm:space-x-32 lg:space-x-0 lg:items-center">
      <button
        className="generatePaletteButtons border-black bg-blue text-white font-bold lg:hidden"
